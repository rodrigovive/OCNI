                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Nombre Completo']) }}
                        </div><!--col-md-6-->
                    </div><!--form-group-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Apellidos Completo']) }}
                        </div><!--col-md-6-->
                    </div><!--form-group-->
