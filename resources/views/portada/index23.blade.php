                    ...
                    <div class="submit-form customform">
                      <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="input-group">
                                  ...
                                  <input type="text" name="finalidad" class="form-control placeSelect2" id="placeSelect2" aria-describedby="basic-addon2"/>
                              </div>
                          </div><!-- end col -->
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="input-group">
                                  ...
                                  <input name="buscarreso" type="text" name="NumResol" class="form-control" placeholder="Buscar por Resolucion" aria-describedby="basic-addon1">
                              </div>
                          </div><!-- end col -->

                          <div class="col-md-3 col-sm-6 col-xs-12">
                              <select class="form-control" name="resol" data-style="btn-default" data-live-search="true">
                                  <option value="" disabled selected>Tipo Resolucion</option>
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-12">
                              <select class="form-control" name="year" data-style="btn-default" data-live-search="true">
                                  <option value="" disabled selected>Año de publicacion Resolucion</option>
                      ...
                      <row>
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <button name='buscar' value="BUSCAR" class="btn btn-custom" title="Presione para Buscar">BUSCAR<Buscar Convenio</button>
                        </div><!-- end col -->
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                          <ul class="list-inline">
                              <li class="checkbox checkbox-primary">
                                  ...
                                  <?php foreach ($tipo_conv as $item) :?>
                                    <input id="{{$item->id}}" type="checkbox" class="styled">
                                    <label for="checkbox_qu_01">
                                      <small>{{$item->nomb_tipo_conv1}}</small>
                                    </label>
                                  <?php endforeach?>
                ...
                <div class="container">
                    ...
                    <div class="all-jobs job-listing clearfix job-tab" name="list2" id="listando">
                      <?php foreach ($year as $item) :?>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12"><div class="job-meta"><p><?php echo $item->tipo_resol ?></p> <small><?php echo $item->finalidad ?></small></div></div>
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12"><div class="job-meta"><p><?php echo $item->programa ?></p> <a href="#" class="btn btn-primary btn-sm btn-block"><span class="glyphicon glyphicon-eye-open"></span></a></div></div>
                        </div>
                      <?php endforeach ?>
        ...
        $.ajax({
            ...
            success:function (detalles) {
                  ...
                  for (var i = 0; i < detalles.length; i++) {
                    ...
                    '<div class="col-md-2 col-sm-2 col-xs-12"><div class="job-meta"><p>'+detalles[i].programa+'</p> <a href="#" class="btn btn-primary btn-sm btn-block">URL</a></div></div>'+
                    '</div>');
                  }
            }
        });
